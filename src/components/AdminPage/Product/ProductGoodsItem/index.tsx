  ...
  return (
    <div className={styles.productGoodsItemContainer}>
      ...
      <div className={styles.productGoodsItemContainer_goodsControl}>
        <Link to={{ pathname: "/admin/editGoods", search: "?goodsID=" + data.id }}><div className={styles.productGoodsItemContainer_goodsControl_text}>編輯</div></Link>
        <div className={styles.productGoodsItemContainer_goodsControl_text} onClick={() => setIsCancelConfrimAlert(true)}>刪除</div>
        {data.isDisplay == 0 ? <div className={styles.productGoodsItemContainer_goodsControl_text} onClick={setIsDisplay}>上架</div> : <div className={styles.productGoodsItemContainer_goodsControl_text} onClick={() => setIsDownConfrimAlert(true)}>下架</div>}
      </div>
